...
|TB2|01/06/26| Sebastian, Miguel, Andy, Stephano, Ruben | Se añadio el capitulo 8 con nuestas hypothesis|
|TF1|06/07/26| Sebastian, Miguel, Andy, Stephano, Ruben | Se implemento las nuevas versiones de nuestras aplicaciones web y mobil|
...
https://matchpoint-frontend-gules.vercel.app/
...
- [Capítulo V: Product Implementatio](#capítulo-v-product-implementatio)
  - [5.1. Software Configuration Management.](#51-software-configuration-management)
    ...
    - [5.1.2. Source Code Management](#512-source-code-management)
      - [Estructura de Repositorios en GitHub:](#estructura-de-repositorios-en-github)
    - [5.1.3. Source Code Style Guide \& Conventions](#513-source-code-style-guide--conventions)
      - [**TypeScript (Frontend Web con Angular)**](#typescript-frontend-web-con-angular)
      - [**Kotlin (Frontend Móvil Android)**](#kotlin-frontend-móvil-android)
      - [**CSS (Cascading Style Sheets)**](#css-cascading-style-sheets)
      - [**Gherkin**](#gherkin)
    - [5.1.4. Software Deployment Configuration](#514-software-deployment-configuration)
    - [**Configuraciones de despliegue del proyecto**](#configuraciones-de-despliegue-del-proyecto)
      - [**Landing Page y Frontend Web (Netlify)**](#landing-page-y-frontend-web-netlify)
      - [**Aplicación Móvil Android (Google Play Store)**](#aplicación-móvil-android-google-play-store)
      - [**Backend**](#backend)
  - [5.2. Product Implementation \& Deployment.](#52-product-implementation--deployment)
    ...
    - [5.2.6. Implemented RESTful API and/or Serverless Backend Evidence](#526-implemented-restful-api-andor-serverless-backend-evidence)
      - [Bookings](#bookings)
      - [Coach Services and Reviews](#coach-services-and-reviews)
      - [Coaches](#coaches-1)
      - [Client Relations](#client-relations)
      - [Payments and User Profiles](#payments-and-user-profiles)
      - [Users](#users)
...
- [Capítulo VII: DevOps Practices](#capítulo-vii-devops-practices)
  - [7.1. Continuous Integration](#71-continuous-integration)
    - [7.1.1. Tools and Practices.](#711-tools-and-practices)
      ...
      - [Prácticas de Integración Continua](#prácticas-de-integración-continua)
    - [7.1.2. Build \& Test Suite Pipeline Components.](#712-build--test-suite-pipeline-components)
      - [7.1.2.1 Backend (Java Spring Boot + JUnit)](#7121-backend-java-spring-boot--junit)
      - [7.1.2.2 Frontend (Vue + Vite + Vitest)](#7122-frontend-vue--vite--vitest)
  - [7.2. Continuous Delivery](#72-continuous-delivery)
    - [7.2.1. Tools and Practices.](#721-tools-and-practices)
      - [Herramientas Seleccionadas](#herramientas-seleccionadas-1)
      - [Estrategias de Despliegue](#estrategias-de-despliegue)
      - [Environments](#environments)
    - [7.2.2. Stages Deployment Pipeline Components.](#722-stages-deployment-pipeline-components)
      - [Diagrama de Stages - CD Pipeline](#diagrama-de-stages---cd-pipeline)
        - [Backend (Java Spring) - Stages](#backend-java-spring---stages)
        - [Frontend (Vue) - Stages](#frontend-vue---stages)
  - [7.3. Continuous deployment](#73-continuous-deployment)
    - [7.3.1. Tools and Practices.](#731-tools-and-practices)
      - [Herramientas Seleccionadas](#herramientas-seleccionadas-2)
      - [Estrategias de Despliegue Automático a Producción](#estrategias-de-despliegue-automático-a-producción)
      - [Diferencia CD (Delivery) vs CD (Deployment)](#diferencia-cd-delivery-vs-cd-deployment)
    - [7.3.2. Production Deployment Pipeline Components.](#732-production-deployment-pipeline-components)
      - [Diagrama General - CD (Deployment) Pipeline](#diagrama-general---cd-deployment-pipeline)
      - [Backend (Java Spring) - Production Deployment](#backend-java-spring---production-deployment)
      - [Frontend Web (Vue) - Production Deployment](#frontend-web-vue---production-deployment)
...
|-------------------------|--------------------------|------------------|
| **Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software** |Velasquez Chambi, Ruben Genaro <br>**TP**<br>Se desarrollaron pruebas unitarias y pruebas integrales para validar el correcto funcionamiento de los servicios y endpoints del backend de la aplicación PlayMatch. Asimismo, se realizó la documentación de la API para garantizar claridad, mantenibilidad y facilidad de integración entre los distintos componentes del sistema. Estas actividades contribuyen a reducir errores, asegurar la calidad del software y brindar una experiencia confiable para entrenadores y deportistas que utilizarán la plataforma.<br><br>**TB2**<br>Se planificó y diseñó la recolección de datos de experimentos (sección 8.2) garantizando que la recopilación de información de usuarios respete los estándares éticos, de confidencialidad y consentimiento, previniendo el mal uso de datos personales.<br><br>**TF**<br>Implementó el backend de las To-Be User Stories (US-01, US-03, US-04, US-06) aplicando principios de seguridad de la información, encriptación en la comunicación de APIs y validación rigurosa de traslapes en horarios de entrenadores para evitar inconsistencias operativas.<br><br>Gutarra Velapatiño, Sebastián <br>**TP**<br>Se desarrollaron los wireframes y mockups acorde a las diferentes secciones que se decidió que tenga la aplicación web y la móvil.<br><br>**TB2**<br>Colaboró en la definición del diseño de experimentos y métricas de negocio (secciones 8.2.1 a 8.2.3), velando por que las hipótesis y medidas planteadas sean transparentes y no induzcan a comportamientos engañosos en los usuarios finales.<br><br>**TF**<br>Diseñó y adaptó los mockups y wireflows para las funcionalidades de la aplicación web y móvil To-Be, asegurando que las interfaces respeten los estándares de accesibilidad (WCAG) y proporcionen un flujo claro y honesto sobre el uso de los servicios.<br><br>Hallasi Saravia, Miguel Angel <br>**TP**<br>Se configuraron pipelines de Continuous Integration y Continuous Delivery utilizando GitHub Actions, Maven y GitHub Actions para backend, y Vite/Vitest para frontend, garantizando build y tests automatizados en cada cambio de código. Además, se elaboró el glosario de Ubiquitous Language para establecer terminología común entre todos los miembros del equipo.<br><br>**TB2**<br>Estructuró y revisó el plan de experimentación inicial (secciones 8.1.1 a 8.1.5), asegurando que los experimentos propuestos cuenten con criterios claros de éxito y sigan buenas prácticas metodológicas, reflejando rigurosidad profesional en la ingeniería de software.<br><br>**TF**<br>Configuró y actualizó los flujos automatizados de compilación y pruebas unitarias/integración (CI/CD) para las versiones To-Be del software, garantizando que cada cambio mantenga la calidad de la plataforma y minimice fallos que afecten la experiencia del usuario.<br><br>Mio Mejia, Andy Alejandro <br>**TP**<br>Se documentó e implementó la estrategia de Continuous Deployment a producción (secciones 7.3.1 y 7.3.2), incluyendo la configuración automática de despliegues para Backend (Render), Frontend Web (Vercel) y App Móvil (Google Play Console). Se definieron políticas de rollback automático, canales de rollout gradual y monitoreo post-despliegue para garantizar la entrega segura y confiable del software en ambiente de producción.<br><br>**TB2**<br>Participó en la formulación de las métricas de analítica de datos y en el plan de tracking web/móvil (secciones 8.2.7 y 8.2.8), estableciendo políticas claras para el almacenamiento ético de eventos de interacción y previniendo la recolección de datos sensibles no autorizados.<br><br>**TF**<br>Implementó y automatizó los despliegues de producción (Vercel y Render) de las aplicaciones To-Be, configurando monitoreo preventivo y planes de contingencia automáticos (rollbacks) para garantizar la alta disponibilidad y la protección de las transacciones de los deportistas y entrenadores.<br><br>Valdivia Quispe, Stephano Renan <br>**TP**<br>Se desarrolló la aplicación móvil Android con Kotlin y Jetpack Compose, implementando flujos de autenticación, visualización de coaches y servicios, y creación de reservas. Se configuró un entorno de pruebas locales con H2 para ejecutar 25 tests automatizados (unitarios e integración), asegurando la calidad del código antes del despliegue a producción. El trabajo garantiza una aplicación funcional, testeada y confiable para usuarios finales de la plataforma MatchPoint.<br><br>**TB2**<br>Diseñó el plan de tracking de eventos específicos en la aplicación móvil (sección 8.2.8), alineando los disparadores de eventos con el respeto a la privacidad del usuario, asegurando que no se recopile información de geolocalización en segundo plano sin consentimiento explícito.<br><br>**TF**<br>Se garantizó la integridad de los datos y privacidad de los usuarios al solucionar vulnerabilidades en el flujo de autenticación de Google OAuth, evitando la duplicidad de perfiles. Además, se desarrollaron migraciones automáticas de base de datos para manejar el cambio de formatos a Base64 sin pérdida de información, demostrando responsabilidad ética y técnica en entornos de producción. |La implementación de pipelines CI/CD y Continuous Deployment aseguran calidad y protegen la experiencia de usuarios reales en la plataforma. |
|   **Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales**|Velasquez Chambi, Ruben Genaro <br>**TP**<br>Se desarrollaron pruebas automatizadas y documentación técnica considerando la necesidad de ofrecer una plataforma estable y accesible para deportistas y entrenadores independientes. La validación del backend permite minimizar fallos durante la reserva de canchas, gestión de entrenamientos y procesamiento de información, contribuyendo a mejorar la experiencia de los usuarios y optimizar procesos deportivos mediante herramientas digitales.<br><br>**TB2**<br>Analizó y seleccionó métodos estadísticos y de cálculo de escala para los experimentos (secciones 8.2.5 y 8.2.6), estimando los costos y viabilidad económica de las pruebas A/B antes del lanzamiento masivo para optimizar el uso de recursos de la startup.<br><br>**TF**<br>Validó la estabilidad del backend y la API bajo cargas simuladas, asegurando que la plataforma MatchPoint soporte picos de tráfico en entornos urbanos y de alta demanda económica sin caídas del servicio, permitiendo transacciones comerciales fluidas para entrenadores independientes.<br><br>Gutarra Velapatiño, Sebastián <br>**TP**<br>Al desarrollar la aplicación nos hemos puesto en el lugar de nuestros segmentos objetivos, así identificar las necesidades tanto de entrenadores como de deportistas que vayan a usar nuestra aplicación y poderlas implementar.<br><br>**TB2**<br>Diseñó hipótesis orientadas al impacto de la interfaz en los usuarios (sección 8.2.1), buscando reducir la fricción digital para deportistas aficionados y maximizar la adopción de herramientas digitales en sectores que tradicionalmente gestionan reservas físicamente.<br><br>**TF**<br>Implementó mejoras UX en la Landing Page responsiva y flujos de reserva web To-Be, permitiendo una experiencia inclusiva que facilita a personas de diferentes rangos de edad y niveles de habilidad digital reservar canchas de manera eficiente.<br><br>Hallasi Saravia, Miguel Angel <br>**TP**<br>Se diseñó e implementó el pipeline de entrega continua permitiendo despliegues automáticos mediante Render y Vercel.<br><br>**TB2**<br>Ayudó a definir las preguntas listas para experimentación y el backlog correspondiente (secciones 8.1.3 y 8.1.4), evaluando cómo cada hipótesis impacta socialmente a la comunidad deportiva local al descentralizar el acceso a entrenadores calificados.<br><br>**TF**<br>Desplegó el flujo de integración de datos en la aplicación web para permitir el consumo fluido de servicios, analizando el impacto de los tiempos de carga en dispositivos de baja gama para asegurar la accesibilidad global a la plataforma.<br><br>Mio Mejia, Andy Alejandro <br>**TP**<br>Se implementó el pipeline de despliegue continuo a producción considerando la confiabilidad y seguridad de la plataforma para usuarios finales. La automatización de despliegues con rollouts graduales y health checks garantiza que los cambios se entreguen de forma segura, minimizando riesgos para deportistas y entrenadores, y permitiendo que la plataforma sea accesible y estable en contextos de alta demanda.<br><br>**TB2**<br>Coordinó la selección de KPIs económicos y de negocio (secciones 8.2.2 y 8.2.7), analizando el impacto de las tarifas de la plataforma en la economía de los entrenadores independientes para garantizar un modelo de negocio sostenible y justo.<br><br>**TF**<br>Aseguró la resiliencia del servicio en producción minimizando el uso innecesario de cómputo en servidores en la nube (lo cual contribuye al ahorro de energía y eficiencia ambiental) y garantizando que la plataforma actúe como un motor económico fiable para entrenadores independientes.<br><br>Valdivia Quispe, Stephano Renan <br>**TP**<br>Se desarrolló la app móvil considerando la accesibilidad y facilidad de uso para deportistas de todas las edades. Se integró con el backend desplegado en Render para garantizar disponibilidad global. La automatización de tests locales con H2 permite validar cambios rápidamente sin afectar el entorno de producción, reduciendo riesgos y asegurando la estabilidad del sistema para usuarios a nivel nacional e internacional.<br><br>**TB2**<br>Diseñó las condiciones y métricas del experimento móvil (sección 8.2.4), analizando el impacto de la conectividad de red intermitente de los usuarios en el consumo de datos celulares para no afectar la economía de los deportistas de bajos recursos.<br><br>**TF**<br>Se implementaron funcionalidades de geolocalización en la aplicación móvil que optimizan la conexión entre deportistas y canchas cercanas de su entorno local, promoviendo el deporte y reduciendo tiempos de desplazamiento. A nivel de accesibilidad web, se mejoraron los contrastes visuales de las interfaces de gestión para asegurar que usuarios con diversas capacidades visuales puedan utilizar la plataforma de manera equitativa e informada. |El trabajo en CI/CD y Continuous Deployment demuestra que la automatización y la entrega continua tienen un impacto directo en la confiabilidad del software y en la accesibilidad de servicios deportivos digitales, favoreciendo la transformación tecnológica de la comunidad deportiva. | 
...
| <img src="images/Andy.jpg" alt="Integrante3" width="100" height="120"><br>**Andy Alejandro Mio Mejia**<br>u202218531 |Estudiante de la carrera de Ingeniería de Software, puedo aportar mucho al equipo, aplicando mis conocimientos en diversos lenguajes de programación |Java, C++, Python, html, css, javascrip, C# y SQL |
...
|---------------------|---|---|---|
| #1  | En la pantalla Mi Perfil tarda mucho en cargar los datos. | 4 | Visibilidad del estado del sistema | 
| #2  | En la pantalla Reservas no hay opción para crear una nueva reserva. | 2 | Consistencia y estándares | 
...
![kpisbookings](./images/lhbookings.png)
![kpispayments](./images/lhpayments.png)
